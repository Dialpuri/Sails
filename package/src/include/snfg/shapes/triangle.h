...
namespace Sails {
    struct Triangle : SNFGShapeBase {
        explicit Triangle(const SNFGNode *node);
    ...
    protected:
        ...
        [[nodiscard]] std::string get_special_tags() const override { return ""; }; // no special tags for triangle
