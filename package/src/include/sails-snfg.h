...
namespace Sails {
     ...
     *
     * The SVGObject struct is used to represent an SVG object, which consists of an object name and a type.
     *
     * The SVGObject struct contains the following members:
    ...
    private:
      ...
      */
     void create_svg(std::vector<SVGObject> &snfg_objects, SNFGNode *parent, SNFGNode *node);
    ...
    private:
     ...
     /**
      * @brief Represents the width of the SVG (Scalable Vector Graphics) document.
      */
