...
namespace Sails {
     ...
     *
     * This class provides a method for writing telemetry log data to a JSON file. The class uses the TelemetryLog
     * object to access the log data and construct the JSON structure.
     */
    class JSONWriter {
    public:
        JSONWriter() = default;
         ...
         * @see JSONWriter
         */
        void write_json_file(TelemetryLog& log, std::ostream &stream);
